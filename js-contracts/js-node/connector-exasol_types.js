...
var ListTaskPayload = module.exports.ListTaskPayload = function(args) {
  this.listType = null;
  if (args) {
    if (args.listType !== undefined && args.listType !== null) {
      this.listType = args.listType;
    }
  }
};
ListTaskPayload.prototype = {};
ListTaskPayload.prototype.read = function(input) {
...
ListTaskPayload.prototype.write = function(output) {
  output.writeStructBegin('ListTaskPayload');
  if (this.listType !== null && this.listType !== undefined) {
    output.writeFieldBegin('listType', Thrift.Type.BYTE, 1);
...
ttypes.SERVICE_NAME = 'dmp-connector-exasol';
ttypes.VERSION = '0.2.0';
ttypes.TASK_IMPORT_CSV = 'task-exasol-import';
ttypes.TASK_EXPORT_CSV = 'task-exasol-export';
ttypes.TASK_EXASOL_EXECUTE = 'task-exasol-execute';
ttypes.TASK_EXASOL_LIST = 'task-exasol-list';
ttypes.LIST_TYPE_SCHEMAS = 1;
ttypes.LIST_TYPE_TABLES = 2;
ttypes.ERR_CODE = 53;
